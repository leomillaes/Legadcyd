...
/* --- FORMULARIO CON ANIMACIÓN DE CARTA QUE SE CIERRA Y VUELA --- */
...
if (form && bigEnvelopeCard) {
  form.addEventListener('submit', function(e) {
    ...
    // Paso 1: Cerrar la solapa del sobre sobre la carta
    bigEnvelopeCard.classList.add('closing');

    // Paso 2: Tras 0.6 segundos (cuando se cierra), hacer volar la carta completa
    setTimeout(() => {
      bigEnvelopeCard.classList.add('flying');
    }, 600);

    // Paso 3: Al terminar el vuelo (1.8s totales), abrir mailto y reiniciar el sobre
    setTimeout(() => {
      ...
      // Restaurar estado de la carta abierta
      form.reset();
